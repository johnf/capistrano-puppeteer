        ...
        configuration.load do
          ...
          namespace :bootstrap do
            ...
            task :puppet_setup do
              ...
              run "#{sudo} apt-get purge -y ruby1.8 ruby libruby1.8 libruby libshadow-ruby1.8"
              ...
              run "#{sudo} apt-get install -y puppet libaugeas-ruby1.9.1 git"
              run "#{sudo} apt-get purge -y ruby1.8 ruby"
